...
def bgw_210_get():
    ...
    bgw_210['2.4ghz_SSID']=label_container[0].findNext('td').contents[0].text
    bgw_210['Guest_SSID']=label_container[0].findNext('td').contents[0].text
    bgw_210['5ghz_SSID']=label_container[0].findNext('td').contents[0].text
